Cypress.Commands.add("adicionarProduto", (nomeProduto, valorDoProduto, corDoProduto) => {
    ...
    if (valorDoProduto === '') {
        ...
        cy.get('#produtovalor').type(valorDoProduto)
    }
    // Cores do Produto
    ...
    if (corDoProduto === '') {
        ...
        cy.get('#produtocores').type(corDoProduto)
    }
    // Salvar o Produto
